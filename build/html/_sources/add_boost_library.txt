...
``libs/libname``, follow these steps:
  ...
  /path/to/boost`` or ``ccmake /path/to/boost``) or, on Windows, using
  the CMake GUI. Once you have reconfigured and generated new
  makefiles or project files, CMake knows about your library.

  3. If your library has compiled sources (i.e., it is not a
  header-only library), follow the instructions on
  :ref:`add_compiled_library` to get CMake building and installing
  your library.
